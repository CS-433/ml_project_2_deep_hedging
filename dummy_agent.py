...
parser.add_argument(
    "--render_interval", default=100, type=int
        ...
        for i in range(args.test_iteration):
            ...
            for t in count():
                ...
                if done or t >= args.max_length_of_trajectory:
                    print(
                        "Ep_i \t{}, the ep_r is \t{:0.2f}, the step is \t{}".format(
                            i, ep_r, t
                        )
                    )
                    ep_r = 0
        ...
        for i in range(args.max_episode):
            ...
            for t in range(200):
                ...
                action = (
                    action
                    + np.random.normal(
                        0, args.exploration_noise, size=env.action_space.shape[0]
                    )
            ...
            total_step += step + 1
            print(
                "Total T:{} Episode: \t{} Total Reward: \t{:0.2f}".format(
